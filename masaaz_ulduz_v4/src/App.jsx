        ...
        <div style={{maxWidth:"960px",margin:"0 auto",padding:"2rem"}}>
          ...
          {dbTables.length===0?(
            ...
            <>
              ...
              {/* Masa planı */}
              <div style={{position:"relative",width:"100%",paddingBottom:"62%",background:"#fff",border:"1px solid #E2E8F0",borderRadius:"14px",overflow:"hidden",marginBottom:"1.5rem",boxShadow:"0 2px 8px rgba(0,0,0,.04)"}}>
              ...
              {selTable&&(()=>{
                ...
                return (
                  <div style={{background:"#fff",border:"2px solid #3B82F6",borderRadius:"14px",padding:"1.3rem",marginBottom:"1.2rem",boxShadow:"0 2px 12px rgba(59,130,246,.1)"}}>
                    ...
                    {selTable.img&&<img src={selTable.img} alt={selTable.label} style={{width:"100%",maxHeight:"220px",objectFit:"cover",borderRadius:"10px",marginBottom:"1rem"}} onError={e=>e.target.style.display="none"}/>}
