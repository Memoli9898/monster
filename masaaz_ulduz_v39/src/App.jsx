...
function PhoneDemoMockup() {
  ...
  const screens = [
    ...
    <div key="time" style={{height:"100%",background:"#eef3f8"}}>
      ...
      <div style={{padding:"0 8px 8px"}}>
        <div style={{background:"#F0FDF4",border:"1.5px solid #86EFAC",borderRadius:"7px",padding:"5px 8px",marginBottom:"6px",display:"flex",alignItems:"center",gap:"5px"}}>
              ...
              return (
                ...
                >
                  ...
                  <div style={{ position:"relative", height:"200px", overflow:"hidden", background: r.cover_url ? "transparent" : `linear-gradient(135deg,${r.accent||"#1a2d42"}cc,${r.accent||"#0d1b2a"}ee)` }}>
                    ...
                    {/* Cuisine + venue tag */}
                    <div style={{ position:"absolute", bottom:"12px", left:"12px", display:"flex", gap:".4rem", alignItems:"center" }}>
                      ...
                      {r.venue_type && r.venue_type !== "restoran" && (
                        <span style={{ fontSize:".62rem", fontWeight:700, padding:".12rem .45rem", borderRadius:"100px",
                          background:"rgba(0,0,0,.45)", color:"rgba(255,255,255,.9)",
                          backdropFilter:"blur(4px)", border:"1px solid rgba(255,255,255,.2)"
                        }}>
                          {{"lounge":"🛋️ Lounge","pub":"🍺 Pub"}[r.venue_type]}
                        </span>
                      )}
                    </div>
                  </div>
