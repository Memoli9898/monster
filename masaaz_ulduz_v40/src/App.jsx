    ...
    <div key="home" style={{height:"100%",background:"#050d17"}}>
      ...
      <div style={{padding:"0 10px 10px"}}>
        <div style={{display:"flex",alignItems:"center",gap:"5px",marginBottom:"12px"}}>
          ...
          <span style={{fontFamily:"'Playfair Display',serif",fontWeight:700,fontSize:".7rem",color:"#fff"}}>MasaAz</span>
        </div>
    ...
    <div style={{fontFamily:"'Inter',system-ui,sans-serif",background:"linear-gradient(155deg,#050d17 0%,#0a1f35 45%,#0f2d4a 100%)",minHeight:"100vh",color:"#fff"}}>
      ...
      <header style={{background:"rgba(5,13,23,.85)",backdropFilter:"blur(20px)",borderBottom:"1px solid rgba(255,255,255,.07)",position:"sticky",top:0,zIndex:100,display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 2rem",height:"60px",boxShadow:"0 1px 20px rgba(0,0,0,.3)"}}>
        <div onClick={reset} style={{cursor:"pointer",display:"flex",alignItems:"center",gap:".6rem"}}>
          <div style={{width:"32px",height:"32px",borderRadius:"8px",background:"#12487a",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1rem"}}>🍽️</div>
          <div><div style={{fontWeight:800,fontSize:"1.05rem",letterSpacing:"-.03em",color:"#fff"}}>MasaAz</div><div style={{fontSize:".55rem",letterSpacing:".15em",textTransform:"uppercase",color:"rgba(255,255,255,.35)",marginTop:"-2px"}}>Rezervasiya</div></div>
        </div>
        <div style={{display:"flex",alignItems:"center",gap:".8rem"}}>
