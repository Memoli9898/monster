        ...
        <div style={{maxWidth:"960px",margin:"0 auto",padding:".8rem"}} onClick={()=>calendarOpen&&setCalOpen(false)}>
            ...
            <div style={{display:"flex",alignItems:"center",gap:".75rem"}}>
              ...
              <div style={{position:"relative",flexShrink:0}}>
                <button onClick={()=>setCalOpen(p=>!p)}
                  style={{display:"flex",alignItems:"center",gap:".4rem",background:selDate?"rgba(200,169,110,.15)":"rgba(255,255,255,.06)",border:`1px solid ${selDate?"rgba(200,169,110,.4)":"rgba(255,255,255,.1)"}`,borderRadius:"10px",padding:".5rem .75rem",cursor:"pointer",fontFamily:"inherit",fontSize:".78rem",fontWeight:600,color:selDate?"#c8a96e":"rgba(255,255,255,.5)",whiteSpace:"nowrap"}}>
          ...
          {dbTables.length===0?(
            ...
            <>
              ...
              {selTable&&(()=>{
                return (
                  <div style={{background:"rgba(200,169,110,.08)",border:"1.5px solid rgba(200,169,110,.3)",borderRadius:"14px",padding:"1.2rem",marginBottom:"1.2rem"}}>
