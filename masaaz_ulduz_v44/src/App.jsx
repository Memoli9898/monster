  ...
  const screens = [
    ...
    <div key="tables" style={{height:"100%",background:"linear-gradient(160deg,#050d17,#0a1f35,#0f2d4a)"}}>
      <div style={{height:"24px",display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 14px",paddingTop:"5px"}}>
        <span style={{fontSize:".45rem",color:"rgba(255,255,255,.5)",fontWeight:600}}>9:41</span>
        <span style={{fontSize:".45rem",color:"rgba(255,255,255,.3)"}}>●●●</span>
      </div>
      <div style={{padding:"0 8px 8px"}}>
        <div style={{background:"rgba(255,255,255,.07)",border:"1px solid rgba(200,169,110,.2)",borderRadius:"8px",padding:"6px 8px",marginBottom:"6px",display:"flex",alignItems:"center",gap:"5px"}}>
          <div style={{width:"20px",height:"20px",borderRadius:"5px",background:"linear-gradient(135deg,#12487a,#c8a96e)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:".6rem",flexShrink:0}}>🍽</div>
          <div style={{flex:1}}>
            <div style={{fontWeight:800,fontSize:".62rem",color:"#fff"}}>Buxar</div>
            <div style={{fontSize:".48rem",color:"rgba(255,255,255,.35)"}}>Saray · Abşeron</div>
          </div>
          <div style={{background:"rgba(200,169,110,.15)",border:"1px solid rgba(200,169,110,.3)",borderRadius:"5px",padding:"2px 5px",fontSize:".48rem",fontWeight:700,color:"#c8a96e"}}>Bu gün</div>
        </div>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"4px",marginBottom:"6px"}}>
          {[{l:"A1",s:4,st:"free"},{l:"A2",s:6,st:"selected"},{l:"A3",s:2,st:"free"},{l:"VIP",s:8,st:"booked"}].map(t=>(
            <div key={t.l} style={{background:t.st==="selected"?"rgba(200,169,110,.15)":t.st==="booked"?"rgba(239,68,68,.1)":"rgba(34,197,94,.08)",border:`1.5px solid ${t.st==="selected"?"#c8a96e":t.st==="booked"?"rgba(239,68,68,.4)":"rgba(34,197,94,.35)"}`,borderRadius:"7px",padding:"5px",textAlign:"center",position:"relative"}}>
              {t.st==="booked"&&<div style={{position:"absolute",top:"2px",right:"3px",width:"4px",height:"4px",borderRadius:"50%",background:"#ef4444"}}/>}
              <div style={{fontWeight:800,fontSize:".55rem",color:t.st==="selected"?"#c8a96e":t.st==="booked"?"rgba(239,68,68,.7)":"rgba(34,197,94,.9)"}}>Masa {t.l}</div>
              <div style={{fontSize:".48rem",color:"rgba(255,255,255,.4)"}}>👥 {t.s} nf</div>
            </div>
          ))}
        </div>
        <div style={{background:"linear-gradient(135deg,#c8a96e,#e0c07a)",color:"#0a1520",borderRadius:"7px",padding:"5px",textAlign:"center",fontSize:".6rem",fontWeight:800}}>Davam et →</div>
      </div>
    </div>,
    <div key="time" style={{height:"100%",background:"linear-gradient(160deg,#050d17,#0a1f35,#0f2d4a)"}}>
      ...
      <div style={{padding:"0 8px 8px"}}>
        <div style={{background:"rgba(200,169,110,.1)",border:"1.5px solid rgba(200,169,110,.3)",borderRadius:"7px",padding:"5px 8px",marginBottom:"6px",display:"flex",alignItems:"center",gap:"5px"}}>
          <span style={{fontSize:".7rem"}}>🪑</span>
          <div>
            <div style={{fontWeight:700,fontSize:".6rem",color:"#c8a96e"}}>Masa A2 seçildi</div>
            <div style={{fontSize:".5rem",color:"rgba(255,255,255,.4)"}}>6 nəfərlik · Buxar</div>
          </div>
        </div>
        <div style={{fontSize:".56rem",fontWeight:700,color:"rgba(200,169,110,.8)",marginBottom:"5px"}}>Saat seçin</div>
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"3px",marginBottom:"6px"}}>
          {["18:00","18:30","19:00","19:30","20:00","20:30"].map((t,i)=>(
            <button key={t} style={{padding:"4px 2px",background:i===2?"linear-gradient(135deg,#c8a96e,#e0c07a)":"rgba(255,255,255,.06)",color:i===2?"#0a1520":"rgba(255,255,255,.5)",border:`1px solid ${i===2?"#c8a96e":"rgba(255,255,255,.1)"}`,borderRadius:"5px",fontSize:".52rem",fontWeight:i===2?800:400,fontFamily:"inherit",cursor:"default"}}>{t}</button>
          ))}
        </div>
        <div style={{background:"linear-gradient(135deg,#c8a96e,#e0c07a)",color:"#0a1520",borderRadius:"7px",padding:"5px",textAlign:"center",fontSize:".6rem",fontWeight:800}}>Məlumatlar →</div>
      </div>
    </div>,
    <div key="success" style={{height:"100%",background:"linear-gradient(160deg,#050d17,#0a1f35,#0f2d4a)",display:"flex",flexDirection:"column",alignItems:"center"}}>
      ...
      <div style={{padding:"2px 8px",textAlign:"center",width:"100%"}}>
        <div style={{width:"36px",height:"36px",borderRadius:"50%",background:"rgba(34,197,94,.12)",border:"2px solid rgba(34,197,94,.4)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:".9rem",margin:"2px auto 5px",color:"#4ade80"}}>✓</div>
        <div style={{fontWeight:800,fontSize:".68rem",color:"#fff",marginBottom:"2px"}}>Rezervasiya Təsdiqləndi!</div>
        <div style={{fontSize:".52rem",color:"rgba(255,255,255,.4)",marginBottom:"7px"}}>Kod: <strong style={{color:"#c8a96e"}}>#AX8K2Z</strong></div>
        <div style={{background:"rgba(255,255,255,.06)",border:"1.5px solid rgba(255,255,255,.12)",borderRadius:"7px",padding:"5px",marginBottom:"5px",display:"inline-block"}}>
          <div style={{width:"50px",height:"50px",margin:"0 auto",background:"repeating-conic-gradient(#c8a96e 0% 25%, #0a1520 0% 50%) 0 0 / 5px 5px",borderRadius:"3px"}}/>
          <div style={{fontSize:".45rem",color:"rgba(255,255,255,.3)",marginTop:"2px",textAlign:"center"}}>QR kod</div>
        </div>
        <div style={{background:"rgba(200,169,110,.1)",border:"1px solid rgba(200,169,110,.25)",borderRadius:"6px",padding:"4px 6px",fontSize:".52rem",color:"rgba(200,169,110,.85)",fontWeight:600}}>📱 Restoranda göstərin</div>
      </div>
    </div>,
  ];
...
function MainApp({ navigate, restSlug, initialStep, preTable }) {
  ...
  const [phoneAttempts,setPhoneAttempts] = useState({});
  const generateOTP = () => String(Math.floor(1000 + Math.random() * 9000));
  const getAttemptCount = (phone) => phoneAttempts[phone] || 0;
  const incrementAttempt = (phone) => setPhoneAttempts(p=>({...p,[phone]:(p[phone]||0)+1}));
  ...
  const submitReservation = async () => {
    const attempts = getAttemptCount(custPhone);
    // 3-cü+ cəhd — blok
    if(attempts >= 3) {
      setSaveErr("⛔ Bu nömrə ilə bu sessiyada artıq 3 rezervasiya edilib. Yenidən girin.");
      return;
    }
    // 2-ci cəhd — OTP lazımdır (artıq doğrulanmayıbsa)
    if(attempts >= 1 && !otpVerified) {
      // OTP göndər, ekranı göstər
      setSaving(true); setSaveErr("");
    ...
    // 1-ci rezervasiya və ya OTP doğrulanıb — davam et
    incrementAttempt(custPhone);
    setOtpVerified(false); // növbəti üçün sıfırla
  ...
  const verifyOTP = () => {
    if(otpInput.trim() === otpCode) {
      ...
      setOtpError("❌ Kod yanlışdır. Yenidən cəhd edin.");
    }
  };
    ...
    <div style={{fontFamily:"'Inter',system-ui,sans-serif",background:"linear-gradient(155deg,#050d17 0%,#0a1f35 45%,#0f2d4a 100%)",minHeight:"100vh",color:"#fff"}}>
      ...
      {step==="success"&&(
        <div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",minHeight:"70vh",padding:"3rem 2rem",textAlign:"center"}}>
          ...
          <a href={"/review?code="+bookingCode} style={{display:"flex",alignItems:"center",justifyContent:"center",gap:".5rem",background:"linear-gradient(135deg,#c8a96e,#e0c07a)",borderRadius:"10px",padding:".75rem 1.5rem",marginBottom:"1rem",color:"#0a1520",textDecoration:"none",fontSize:".85rem",fontWeight:700}}>⭐ Rəyinizi bildirin — 30 saniyə çəkir</a>
