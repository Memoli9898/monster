...
function MainApp({ navigate, restSlug, initialStep, preTable }) {
  ...
  const submitReservation=async()=>{
    ...
    // WhatsApp xəbərdarlığı — admin paneldəki şablondan oxu
    ...
    let waMsg = tpl
      ...
      .replace(/{restaurant}/g, selRest.name)
      .replace(/{date}/g, selDate)
      .replace(/{time}/g, selTime)
      .replace(/{guests}/g, guests)
      .replace(/{table}/g, selTable.label)
      .replace(/{code}/g, code);
