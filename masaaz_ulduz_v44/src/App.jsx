...
function PhoneDemoMockup() {
  ...
  useEffect(() => {
    const t = setInterval(() => {
      setFade(false);
      setTimeout(() => { setScreenIdx(s => (s + 1) % 4); setFade(true); }, 280);
    }, 3200);
    return () => clearInterval(t);
  }, []);

  const screens = [
    <div key="home" style={{height:"100%",background:"#050d17"}}>
      <div style={{height:"24px",display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 14px 0",paddingTop:"5px"}}>
        <span style={{fontSize:".45rem",color:"rgba(255,255,255,.5)",fontWeight:600}}>9:41</span>
        <span style={{fontSize:".45rem",color:"rgba(255,255,255,.4)"}}>●●●</span>
      </div>
      <div style={{padding:"0 10px 10px"}}>
        <div style={{display:"flex",alignItems:"center",gap:"5px",marginBottom:"12px"}}>
          <div style={{width:"20px",height:"20px",borderRadius:"5px",background:"linear-gradient(135deg,#12487a,#1a5c8a)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:".55rem"}}>🍽️</div>
          <span style={{fontFamily:"'Playfair Display',serif",fontWeight:900,fontSize:".7rem",color:"#fff"}}><span style={{color:"#c8a96e"}}>1</span>rezerv</span>
        </div>
        <div style={{fontFamily:"'Playfair Display',serif",fontSize:".88rem",fontWeight:900,color:"#fff",lineHeight:1.2,marginBottom:"2px"}}>Masanızı elə indi</div>
        <div style={{fontFamily:"'Playfair Display',serif",fontSize:".88rem",fontWeight:900,color:ac,marginBottom:"10px"}}>rezerv edin</div>
        <div style={{background:"rgba(255,255,255,.08)",borderRadius:"7px",padding:"5px 8px",fontSize:".52rem",color:"rgba(255,255,255,.4)",marginBottom:"8px",display:"flex",alignItems:"center",gap:"4px"}}>🔍 Restoran axtar...</div>
        {[{e:"🍽️",n:"Buxar",l:"Saray",c:"#1a5c8a"},{e:"🥩",n:"Steak House",l:"Neftçilər",c:"#7c3030"}].map((r,i)=>(
          <div key={i} style={{background:"rgba(255,255,255,.06)",border:"1px solid rgba(255,255,255,.09)",borderRadius:"9px",padding:"6px 8px",marginBottom:"5px",display:"flex",alignItems:"center",gap:"6px"}}>
            <div style={{width:"24px",height:"24px",borderRadius:"6px",background:`linear-gradient(135deg,${r.c},${r.c}88)`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:".75rem",flexShrink:0}}>{r.e}</div>
            <div style={{flex:1}}>
              <div style={{fontWeight:700,fontSize:".6rem",color:"#fff"}}>{r.n}</div>
              <div style={{fontSize:".48rem",color:"rgba(255,255,255,.35)"}}>📍 {r.l}</div>
            </div>
            <div style={{background:ac,color:"#0a1f35",borderRadius:"5px",padding:"2px 5px",fontSize:".48rem",fontWeight:800}}>Rezerv</div>
          </div>
        ))}
      </div>
    </div>,
    <div key="tables" style={{height:"100%",background:"#eef3f8"}}>
      <div style={{height:"24px",display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 14px",paddingTop:"5px"}}>
        <span style={{fontSize:".45rem",color:"#94A3B8",fontWeight:600}}>9:41</span>
        <span style={{fontSize:".45rem",color:"#94A3B8"}}>●●●</span>
      </div>
      <div style={{padding:"0 8px 8px"}}>
        <div style={{background:"#fff",borderRadius:"8px",padding:"6px 8px",marginBottom:"6px",display:"flex",alignItems:"center",gap:"5px",boxShadow:"0 1px 4px rgba(0,0,0,.06)"}}>
          <span style={{fontSize:".75rem"}}>🍽️</span>
          <div style={{flex:1}}>
            <div style={{fontWeight:800,fontSize:".62rem",color:"#12487a"}}>Buxar</div>
            <div style={{fontSize:".48rem",color:"#94A3B8"}}>Saray · Abşeron</div>
          </div>
          <div style={{background:"#e8f2fb",border:"1px solid #12487a",borderRadius:"5px",padding:"2px 5px",fontSize:".48rem",fontWeight:700,color:"#12487a"}}>📅 Bu gün</div>
        </div>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"4px",marginBottom:"6px"}}>
          {[{l:"A1",s:4,st:"free"},{l:"A2",s:6,st:"selected"},{l:"A3",s:2,st:"free"},{l:"VIP",s:8,st:"booked"}].map(t=>(
            <div key={t.l} style={{background:t.st==="selected"?"#e8f2fb":t.st==="booked"?"#FEF2F2":"#F0FDF4",border:`1.5px solid ${t.st==="selected"?"#12487a":t.st==="booked"?"#FCA5A5":"#86EFAC"}`,borderRadius:"7px",padding:"5px",textAlign:"center"}}>
              <div style={{fontSize:".58rem"}}>{t.st==="selected"?"✅":t.st==="booked"?"🔴":"🟢"}</div>
              <div style={{fontWeight:800,fontSize:".55rem",color:t.st==="selected"?"#1a5c8a":t.st==="booked"?"#DC2626":"#12487a"}}>Masa {t.l}</div>
              <div style={{fontSize:".48rem",color:"#94A3B8"}}>👥 {t.s} nf</div>
            </div>
          ))}
        </div>
        <div style={{background:"#12487a",color:"#fff",borderRadius:"7px",padding:"5px",textAlign:"center",fontSize:".6rem",fontWeight:700}}>Davam et →</div>
      </div>
    </div>,
    <div key="time" style={{height:"100%",background:"#eef3f8"}}>
      <div style={{height:"24px",display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 14px",paddingTop:"5px"}}>
        <span style={{fontSize:".45rem",color:"#94A3B8",fontWeight:600}}>9:41</span>
        <span style={{fontSize:".45rem",color:"#94A3B8"}}>●●●</span>
      </div>
      <div style={{padding:"0 8px 8px"}}>
        <div style={{background:"rgba(200,169,110,.08)",border:"1.5px solid rgba(200,169,110,.25)",borderRadius:"7px",padding:"5px 8px",marginBottom:"6px",display:"flex",alignItems:"center",gap:"5px"}}>
          <span style={{fontSize:".75rem"}}>🪑</span>
          <div>
            <div style={{fontWeight:700,fontSize:".6rem",color:"#16A34A"}}>Masa A2 seçildi</div>
            <div style={{fontSize:".5rem",color:"#166534"}}>6 nəfərlik · Buxar</div>
          </div>
        </div>
        <div style={{fontSize:".56rem",fontWeight:700,color:"#12487a",marginBottom:"5px"}}>⏰ Saat seçin</div>
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"3px",marginBottom:"6px"}}>
          {["18:00","18:30","19:00","19:30","20:00","20:30"].map((t,i)=>(
            <button key={t} style={{padding:"4px 2px",background:i===2?"#12487a":"#F8FAFC",color:i===2?"#fff":"#12487a",border:`1.5px solid ${i===2?"#12487a":"#E2E8F0"}`,borderRadius:"5px",fontSize:".52rem",fontWeight:i===2?700:500,fontFamily:"inherit",cursor:"default"}}>{t}</button>
          ))}
        </div>
        <div style={{background:"#12487a",color:"#fff",borderRadius:"7px",padding:"5px",textAlign:"center",fontSize:".6rem",fontWeight:700}}>Məlumatlar →</div>
      </div>
    </div>,
    <div key="success" style={{height:"100%",background:"#eef3f8",display:"flex",flexDirection:"column",alignItems:"center"}}>
      <div style={{height:"24px",width:"100%",display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0 14px",paddingTop:"5px"}}>
        <span style={{fontSize:".45rem",color:"#94A3B8",fontWeight:600}}>9:41</span>
        <span style={{fontSize:".45rem",color:"#94A3B8"}}>●●●</span>
      </div>
      <div style={{padding:"2px 8px",textAlign:"center",width:"100%"}}>
        <div style={{width:"36px",height:"36px",borderRadius:"50%",background:"#F0FDF4",border:"2px solid #86EFAC",display:"flex",alignItems:"center",justifyContent:"center",fontSize:".9rem",margin:"2px auto 5px"}}>✓</div>
        <div style={{fontWeight:800,fontSize:".68rem",color:"#12487a",marginBottom:"2px"}}>Rezervasiya Təsdiqləndi!</div>
        <div style={{fontSize:".52rem",color:"#64748B",marginBottom:"7px"}}>Kod: <strong style={{color:"#12487a"}}>#AX8K2Z</strong></div>
        <div style={{background:"#fff",border:"1px solid #E2E8F0",borderRadius:"7px",padding:"5px",marginBottom:"5px",display:"inline-block"}}>
          <div style={{width:"50px",height:"50px",margin:"0 auto",background:"repeating-conic-gradient(#0f172a 0% 25%, white 0% 50%) 0 0 / 5px 5px",borderRadius:"3px"}}/>
          <div style={{fontSize:".45rem",color:"#94A3B8",marginTop:"2px",textAlign:"center"}}>QR kod</div>
        </div>
        <div style={{background:"#e8f2fb",border:"1px solid #a8cce0",borderRadius:"6px",padding:"4px 6px",fontSize:".52rem",color:"#0e3d6b",fontWeight:600}}>📱 Restoranda göstərin</div>
      </div>
    </div>,
  ];
  ...
  return (
    <div style={{width:"200px",flexShrink:0}}>
      <style>{`
        @keyframes phoneFloat{0%,100%{transform:translateY(0) rotate(-1.5deg)}50%{transform:translateY(-12px) rotate(-1.5deg)}}
        @keyframes screenSlideUp{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}}
        .phone-screen-anim{animation:screenSlideUp .28s ease}
        @media(max-width:900px){.phone-mockup-wrapper{display:none!important;}.phone-mobile-section{display:flex!important;}}
      `}</style>
      <div style={{
        width:"200px",height:"400px",
        background:"linear-gradient(160deg,#1e2a3a,#0f1820)",
        borderRadius:"36px",
        padding:"10px 8px 14px",
        boxShadow:"0 30px 80px rgba(0,0,0,.75),0 0 0 1.5px rgba(255,255,255,.08),inset 0 1px 0 rgba(255,255,255,.12)",
        position:"relative",
        animation:"phoneFloat 4s ease-in-out infinite",
      }}>
        <div style={{position:"absolute",top:"10px",left:"50%",transform:"translateX(-50%)",width:"62px",height:"16px",background:"#0f1820",borderRadius:"0 0 10px 10px",zIndex:10}}/>
        <div style={{position:"absolute",top:"14px",left:"50%",transform:"translateX(-50%)",display:"flex",gap:"3px",zIndex:11}}>
          <div style={{width:"4px",height:"4px",borderRadius:"50%",background:"rgba(255,255,255,.12)"}}/>
          <div style={{width:"4px",height:"4px",borderRadius:"50%",background:"rgba(255,255,255,.12)"}}/>
        </div>
        ...
        <div style={{position:"absolute",bottom:"6px",left:"50%",transform:"translateX(-50%)",width:"50px",height:"3px",background:"rgba(255,255,255,.2)",borderRadius:"2px"}}/>
        <div style={{position:"absolute",right:"-3px",top:"80px",width:"3px",height:"40px",background:"rgba(0,0,0,.5)",borderRadius:"2px"}}/>
        <div style={{position:"absolute",left:"-3px",top:"60px",width:"3px",height:"28px",background:"rgba(0,0,0,.5)",borderRadius:"2px"}}/>
        <div style={{position:"absolute",left:"-3px",top:"94px",width:"3px",height:"28px",background:"rgba(0,0,0,.5)",borderRadius:"2px"}}/>
      </div>
      <div style={{display:"flex",justifyContent:"center",gap:"5px",marginTop:"12px"}}>
        {[0,1,2,3].map(i=>(
          <div key={i} style={{width:i===screenIdx?"18px":"5px",height:"5px",borderRadius:"3px",background:i===screenIdx?ac:"rgba(255,255,255,.2)",transition:"all .3s ease"}}/>
        ))}
      </div>
      <div style={{textAlign:"center",marginTop:"6px",fontSize:".52rem",color:"rgba(255,255,255,.3)",letterSpacing:".1em",textTransform:"uppercase"}}>
        {["Restoran seç","Masa seç","Saat seç","Təsdiqləndi"][screenIdx]}
      </div>
    </div>
  );
}
