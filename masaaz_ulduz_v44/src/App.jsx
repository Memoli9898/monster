          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(300px,1fr))", gap:"1.5rem" }}>
            {filtered.map(r => {
              ...
              if(r.hours){
                ...
                if(hm){ const o=parseInt(hm[1])*60+parseInt(hm[2]); const c=parseInt(hm[3])*60+parseInt(hm[4]); isOpenNow=nowHm>=o&&nowHm<c; }
              }
              return (
                <div
                  key={r.id}
                ...
                >
                  ...
                  <div style={{ position:"relative", height:"180px", overflow:"hidden", background: r.cover_url ? "transparent" : `linear-gradient(135deg,${ac}cc,${ac}55)` }}>
                    ...
                    <div style={{ position:"absolute", top:"10px", left:"10px", right:"10px", display:"flex", justifyContent:"space-between", alignItems:"flex-start" }}>
                      ...
                      {rating && (
                        <div style={{ background:"rgba(255,255,255,.92)", borderRadius:"100px", padding:".25rem .7rem", display:"flex", alignItems:"center", gap:".3rem", fontSize:".75rem", fontWeight:700, color:"#1a1a2e", boxShadow:"0 2px 8px rgba(0,0,0,.15)", marginLeft:"auto" }}>
