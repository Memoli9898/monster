  ...
  return (
    <div style={{ ...f, background:"#eef3f8", minHeight:"100vh", color:"#12487a" }}>
      ...
      <div style={{ maxWidth:"800px", margin:"0 auto", padding:"2rem" }}>
        ...
        {(rest.phone || rest.hours || rest.location) && (()=>{
          ...
          const mapsQ = encodeURIComponent((rest.location||rest.name)+", Bakı, Azərbaycan");
          const navUrl = `https://www.google.com/maps/dir/?api=1&destination=${mapsQ}`;
          const embedUrl = `https://maps.google.com/maps?q=${mapsQ}&output=embed&z=16&hl=az`;
