...
function HomePage({ navigate, search: searchProp }) {
  ...
  return (
    <div style={{ fontFamily:"'Inter',system-ui,sans-serif", background:"#F8FAFC", minHeight:"100vh", color:"#0F172A", overflowX:"hidden", maxWidth:"100vw" }}>
      <style>{css}</style>
      <header style={{ background:"#fff", borderBottom:"1px solid #E2E8F0", position:"sticky", top:0, zIndex:100, display:"flex", alignItems:"center", justifyContent:"space-between", padding:"0 1rem", height:"56px", boxShadow:"0 1px 3px rgba(0,0,0,.04)", gap:".5rem" }}>
        <div style={{ display:"flex", alignItems:"center", gap:".5rem", flexShrink:0 }}>
          <div style={{ width:"30px", height:"30px", borderRadius:"8px", background:"#0F172A", display:"flex", alignItems:"center", justifyContent:"center", fontSize:".9rem" }}>🍽️</div>
          <div>
            <div style={{ fontWeight:800, fontSize:".9rem", letterSpacing:"-.03em" }}>MasaAz</div>
            <div style={{ fontSize:".5rem", letterSpacing:".12em", textTransform:"uppercase", color:"#94A3B8", marginTop:"-2px" }}>Rezervasiya</div>
          </div>
        </div>
        <div style={{ display:"flex", gap:".4rem", alignItems:"center" }}>
          <button onClick={() => navigate("/cancel")} style={{ background:"none", border:"1px solid #E2E8F0", color:"#64748B", padding:".35rem .6rem", borderRadius:"8px", fontSize:".72rem", fontWeight:600, cursor:"pointer", fontFamily:"inherit", whiteSpace:"nowrap" }}>
            ✕ Ləğv et
          </button>
          <button onClick={() => navigate("/onboard")} style={{ background:"#0F172A", color:"#fff", border:"none", padding:".35rem .6rem", borderRadius:"8px", fontSize:".72rem", fontWeight:600, cursor:"pointer", fontFamily:"inherit", whiteSpace:"nowrap" }}>
            + Qeydiyyat
          </button>
        </div>
      </header>

      <div style={{ background:"#0F172A", color:"#fff", padding:"2.5rem 1.2rem 2rem", textAlign:"center" }}>
      ...
      {!["home","success","cancel"].includes(step)&&(
        <div style={{background:"#fff",borderBottom:"1px solid #E2E8F0",display:"flex",justifyContent:"center",overflow:"hidden"}}>
          {["Masa Seçimi","Menyu","Məlumatlar"].map((s,i)=>{
            ...
            return (
              <div key={s} style={{display:"flex",alignItems:"center",gap:".3rem",padding:".75rem .8rem",borderBottom:`2px solid ${done?"#2563EB":active?"#93C5FD":"transparent"}`,flex:1,justifyContent:"center",minWidth:0}}>
                <div style={{width:"20px",height:"20px",borderRadius:"50%",background:done?"#2563EB":active?"#EFF6FF":"#F1F5F9",border:`1.5px solid ${done?"#2563EB":active?"#3B82F6":"#E2E8F0"}`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:".6rem",fontWeight:700,color:done?"#fff":active?"#2563EB":"#94A3B8",flexShrink:0}}>{done?"✓":i+1}</div>
                <span style={{fontSize:".65rem",fontWeight:600,letterSpacing:".03em",textTransform:"uppercase",color:done?"#2563EB":active?"#1E40AF":"#94A3B8",whiteSpace:"nowrap",overflow:"hidden",textOverflow:"ellipsis"}}>{s}</span>
              </div>
            );
          })}
        </div>
          ...
          {dbTables.length===0?(
            ...
            <>
              ...
              <div style={{display:"flex",gap:"1rem",marginBottom:"1rem",flexWrap:"wrap",alignItems:"center"}}>
                {[{bg:"#F0FDF4",bc:"#86EFAC",tc:"#16A34A",l:"🟢 Boş"},{bg:"#EFF6FF",bc:"#3B82F6",tc:"#2563EB",l:"✅ Seçilmiş"},{bg:"#FEF2F2",bc:"#FCA5A5",tc:"#DC2626",l:"🔴 Tam dolu"}].map(s=>(
                ...
                {dbTables.map(t=>{
                  ...
                  return (
                    <div key={t.id}
                      ...
                      style={{
                        background: isSelected?"#EFF6FF":isFullyBooked?"#FEF2F2":"#F0FDF4",
                        border:`2px solid ${isSelected?"#3B82F6":isFullyBooked?"#FCA5A5":"#86EFAC"}`,
                        borderRadius:"14px",
                        padding:"1rem .75rem",
                      ...
                      <div style={{fontWeight:800,fontSize:"1rem",color:isSelected?"#2563EB":isFullyBooked?"#DC2626":"#0F172A"}}>
                        Masa {t.label}
                      </div>
                      ...
                      {selDate&&!isFullyBooked&&(
                        <div style={{marginTop:".4rem",background:isSelected?"#BFDBFE":"#DCFCE7",borderRadius:"20px",padding:".15rem .5rem",fontSize:".65rem",fontWeight:700,color:isSelected?"#1E40AF":"#16A34A"}}>
                      ...
                      {isSelected&&(
                        <div style={{position:"absolute",top:"-6px",right:"-6px",background:"#2563EB",color:"#fff",borderRadius:"50%",width:"20px",height:"20px",display:"flex",alignItems:"center",justifyContent:"center",fontSize:".7rem",fontWeight:800}}>✓</div>
                      )}
                    </div>
                  );
                })}
              ...
              {selTable&&(()=>{
                ...
                return (
                  <div style={{background:"#fff",border:"2px solid #3B82F6",borderRadius:"14px",padding:"1.2rem",marginBottom:"1.2rem",boxShadow:"0 2px 12px rgba(59,130,246,.1)"}}>
                          ...
                          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(80px,1fr))",gap:".4rem"}}>
                            {freeSlots.map(slot=>(
                              <button key={slot} onClick={()=>setSelTime(slot)}
                                style={{padding:".55rem .4rem",background:selTime===slot?"#0F172A":"#F8FAFC",color:selTime===slot?"#fff":"#0F172A",border:`1.5px solid ${selTime===slot?"#0F172A":"#E2E8F0"}`,borderRadius:"8px",fontSize:".82rem",fontWeight:selTime===slot?700:500,cursor:"pointer",fontFamily:"inherit",textAlign:"center"}}>
                                {slot}
                              </button>
                            ))}
                          </div>
              ...
              {!selTable&&(
                <div style={{background:"#F8FAFC",border:"1.5px dashed #CBD5E1",borderRadius:"12px",padding:"1.2rem",textAlign:"center",color:"#94A3B8",marginBottom:"1.2rem"}}>
              ...
              <button className="btnp" onClick={()=>navigateStep("menu")} disabled={!selTable||!selTime||!selDate}
                style={{background:selTable&&selTime&&selDate?"#0F172A":"#E2E8F0",color:selTable&&selTime&&selDate?"#fff":"#94A3B8",border:"none",padding:".9rem 2rem",fontFamily:"inherit",fontSize:".95rem",fontWeight:700,cursor:selTable&&selTime&&selDate?"pointer":"not-allowed",borderRadius:"10px",width:"100%"}}>
                Davam et — Menyu →
              </button>
            </>
          )}
      ...
      {step==="menu"&&selRest&&selTable&&(
        <div style={{maxWidth:"720px",margin:"0 auto",padding:"1rem"}}>
          ...
          <div style={{display:"flex",gap:".8rem",flexWrap:"wrap"}}>
            <button className="btnp" onClick={()=>navigateStep("datetime")} style={{background:"#0F172A",color:"#fff",border:"none",padding:".9rem 1.8rem",fontFamily:"inherit",fontSize:".92rem",fontWeight:700,cursor:"pointer",borderRadius:"10px"}}>
              Davam et — Məlumatlar →
            </button>
