...
function HomePage({ navigate, search: searchProp }) {
  ...
  const normCuisine = c => {
    if(!c) return "";
    const t = c.trim();
    // Məşhur typo düzəltmələri
    const map = {"Azerbaycabn":"Azərbaycan","azerbaycabn":"Azərbaycan","Azerbaycan":"Azərbaycan","azerbaycan":"Azərbaycan","AZERBAYCABN":"Azərbaycan","AZERBAYCAN":"Azərbaycan"};
    return map[t] || t;
  };
